...
## [1.13.1](https://gitea.ocram85.com/arkanum/arkanum/releases/tag/v1.13.1) - 2026-09-23
...
- chore(deps): update quay.io/linuxserver.io/code-server docker tag to v4.138.0 [[#283](https://gitea.ocram85.com/arkanum/arkanum/pulls/283)]
- chore(deps): update dependency prettier to v3.9.8 [[#284](https://gitea.ocram85.com/arkanum/arkanum/pulls/284)]
- chore(deps): update commitlint/commitlint docker tag to v21.2.3 [[#281](https://gitea.ocram85.com/arkanum/arkanum/pulls/281)]
- chore(deps): update dependency prettier to v3.9.7 [[#282](https://gitea.ocram85.com/arkanum/arkanum/pulls/282)]
- chore(deps): update quay.io/linuxserver.io/code-server docker tag to v4.137.0 [[#279](https://gitea.ocram85.com/arkanum/arkanum/pulls/279)]
- chore(deps): update quay.io/linuxserver.io/code-server docker tag to v4.136.2 [[#278](https://gitea.ocram85.com/arkanum/arkanum/pulls/278)]
- chore(deps): update oven/bun docker tag to v1.4.2 [[#277](https://gitea.ocram85.com/arkanum/arkanum/pulls/277)]
- chore(deps): update oven/bun docker tag to v1.4.1 [[#276](https://gitea.ocram85.com/arkanum/arkanum/pulls/276)]
- chore(deps): update quay.io/linuxserver.io/code-server docker tag to v4.135.0 [[#275](https://gitea.ocram85.com/arkanum/arkanum/pulls/275)]
- chore(deps): update quay.io/linuxserver.io/code-server docker tag to v4.134.0 [[#274](https://gitea.ocram85.com/arkanum/arkanum/pulls/274)]
- chore(deps): update oven/bun docker tag to v1.4.0 [[#273](https://gitea.ocram85.com/arkanum/arkanum/pulls/273)]
- chore(deps): update quay.io/linuxserver.io/code-server docker tag to v4.133.0 [[#272](https://gitea.ocram85.com/arkanum/arkanum/pulls/272)]
- chore(deps): update commitlint/commitlint docker tag to v21.2.2 [[#271](https://gitea.ocram85.com/arkanum/arkanum/pulls/271)]
- chore(deps): update quay.io/linuxserver.io/code-server docker tag to v4.132.0 [[#269](https://gitea.ocram85.com/arkanum/arkanum/pulls/269)]
...
- feat(blog): add release post [[#222](https://gitea.ocram85.com/arkanum/arkanum/pulls/222)]
